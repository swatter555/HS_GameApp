        ...
        private static void Create_TANK_M551_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    hardDefense: GameData.GEN1_TANK_HARD_DEFENSE + MEDIUM_MALUS,
                    softAttack: GameData.BASE_TANK_SOFT_ATTACK + LARGE_MALUS,
                    softDefense: GameData.BASE_TANK_SOFT_DEFENSE,
                    groundAirDefense: GameData.GROUND_DEFENSE_ARMOR,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
                    indirectRange: GameData.INDIRECT_RANGE_DEFAULT,
        ...
        private static void Create_IFV_AMX10P_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    hardDefense: GameData.BASE_IFV_HARD_DEFENSE,
                    softAttack: GameData.BASE_IFV_SOFT_ATTACK,
                    softDefense: GameData.BASE_IFV_SOFT_DEFENSE + LARGE_BONUS,
                    groundAirDefense: GameData.GROUND_DEFENSE_LIGHTARMOR,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
                    indirectRange: GameData.INDIRECT_RANGE_DEFAULT,
                    spottingRange: GameData.BASE_UNIT_SPOTTING_RANGE,
        ...
        private static void Create_GENERIC_RPG7_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    hardDefense: GameData.BASE_INF_HARD_DEFENSE + MEDIUM_MALUS,
                    softAttack: GameData.BASE_INF_SOFT_ATTACK + MEDIUM_MALUS,
                    softDefense: GameData.BASE_INF_SOFT_DEFENSE + MEDIUM_MALUS,
                    groundAirDefense: GameData.GROUND_DEFENSE_INFANTRY,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
                    indirectRange: GameData.INDIRECT_RANGE_DEFAULT,
                    spottingRange: GameData.BASE_UNIT_SPOTTING_RANGE,
        ...
        private static void Create_GENERIC_CAVALRY_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    nationality: Nationality.GENERIC,
                    weaponSystemID: WeaponSystems.CAVALRY_GENERIC,
                    prestigeCost: GameData.PRESTIGE_TIER_0,
                    weaponSystemType: WeaponSystemType.Soft,
                    hardAttack: GameData.BASE_INF_HARD_ATTACK,
                    hardDefense: GameData.BASE_INF_HARD_DEFENSE,
                ...
                // Store in master dictionary
                _weaponSystemProfiles[WeaponSystems.CAVALRY_GENERIC] = profile;
            }
            catch (Exception e)
            {
        ...
        private static void Create_GENERIC_TRUCK_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    name: "Truck",
                    nationality: Nationality.GENERIC,
                    weaponSystemID: WeaponSystems.TRUCK_GENERIC,
                    prestigeCost: GameData.PRESTIGE_TIER_0,
                    weaponSystemType: WeaponSystemType.Soft,
                ...
                // Store in master dictionary
                _weaponSystemProfiles[WeaponSystems.TRUCK_GENERIC] = profile;
            }
            catch (Exception e)
            {
