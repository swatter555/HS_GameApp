...
namespace HammerAndSickle.Models
{
    ...
    public class LandBaseProfile : ISerializable
    {
        ...
        public string BaseName { get; private set; }                      // Name of the facility
        ...
        public LandBaseProfile(string name, Side side, int initialDamage = 0)
        {
            try
            {
        ...
        public virtual LandBaseProfile Clone()
        {
            try
            {
                var clone = new LandBaseProfile();
