...
namespace HammerAndSickle.Models
{
    ...
    public struct Position2D : IEquatable<Position2D>
    {
        ...
        // Gets or sets the width component (alias for X).
        [JsonIgnore] public float Width { readonly get { return X; } set => X = value; }

        // Gets or sets the height component (alias for Y).
        [JsonIgnore] public float Height { readonly get { return Y; } set => Y = value; }
        ...
        /// Used for JSON deserialization and general construction.
        /// </summary>
