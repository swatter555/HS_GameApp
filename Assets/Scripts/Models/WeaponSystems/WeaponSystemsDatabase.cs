    ...
    public static class WeaponSystemsDatabase
    {
        ...
        private static void CreateAllWeaponSystemProfiles()
        {
            try
            {
                ...
                Create_GENERIC_LightAT_Profile();
        ...
        private static void Create_TANK_T55A_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    hardAttack:  GameData.GEN1_TANK_HARD_ATTACK,
                    hardDefense: GameData.GEN1_TANK_HARD_DEFENSE,
                    softAttack:  GameData.BASE_TANK_SOFT_ATTACK,
                    softDefense: GameData.BASE_TANK_SOFT_DEFENSE,
                    groundAirDefense: GameData.GROUND_DEFENSE_ARMOR,
                    primaryRange:    GameData.PRIMARY_RANGE_DEFAULT,
                    indirectRange:   GameData.INDIRECT_RANGE_DEFAULT,
                    ...
                    movementPoints: GameData.MECH_UNIT
                );
            ...
            {
                AppService.HandleException(CLASS_NAME, "CreateT55AProfile", e);
                throw;
            }
        }
        ...
        private static void Create_TANK_T64A_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    weaponSystemType: WeaponSystemType.Hard,
                    hardAttack: GameData.GEN2_TANK_HARD_ATTACK + SMALL_BONUS,
                    hardDefense: GameData.GEN2_TANK_HARD_DEFENSE + MEDIUM_BONUS,
                    softAttack: GameData.BASE_TANK_SOFT_ATTACK,
                    softDefense: GameData.BASE_TANK_SOFT_DEFENSE + SMALL_BONUS,
                    groundAirDefense: GameData.GROUND_DEFENSE_ARMOR,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
                    indirectRange: GameData.INDIRECT_RANGE_DEFAULT,
                    spottingRange: GameData.BASE_UNIT_SPOTTING_RANGE,
        ...
        private static void Create_TANK_T64B_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    weaponSystemType: WeaponSystemType.Hard,
                    hardAttack: GameData.GEN3_TANK_HARD_ATTACK + MEDIUM_BONUS,
                    hardDefense: GameData.GEN3_TANK_HARD_DEFENSE + SMALL_BONUS,
                    softAttack: GameData.BASE_TANK_SOFT_ATTACK,
                    softDefense: GameData.BASE_TANK_SOFT_DEFENSE + MEDIUM_BONUS,
                    groundAirDefense: GameData.GROUND_DEFENSE_ARMOR,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
                    indirectRange: GameData.INDIRECT_RANGE_DEFAULT,
                    spottingRange: GameData.BASE_UNIT_SPOTTING_RANGE,
        ...
        private static void Create_TANK_T72A_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    weaponSystemType: WeaponSystemType.Hard,
                    hardAttack: GameData.GEN2_TANK_HARD_ATTACK + MEDIUM_BONUS,
                    hardDefense: GameData.GEN2_TANK_HARD_DEFENSE + SMALL_BONUS,
                    softAttack: GameData.BASE_TANK_SOFT_ATTACK,
                    softDefense: GameData.BASE_TANK_SOFT_DEFENSE + SMALL_MALUS,
                    groundAirDefense: GameData.GROUND_DEFENSE_ARMOR,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
                    indirectRange: GameData.INDIRECT_RANGE_DEFAULT,
                    spottingRange: GameData.BASE_UNIT_SPOTTING_RANGE,
        ...
        private static void Create_TANK_T72B_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    prestigeCost: GameData.PRESTIGE_TIER_3,
                    weaponSystemType: WeaponSystemType.Hard,
                    hardAttack: GameData.GEN3_TANK_HARD_ATTACK,
                    hardDefense: GameData.GEN3_TANK_HARD_DEFENSE,
                    softAttack: GameData.BASE_TANK_SOFT_ATTACK,
                    softDefense: GameData.BASE_TANK_SOFT_DEFENSE + SMALL_MALUS,
                    groundAirDefense: GameData.GROUND_DEFENSE_ARMOR,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
        ...
        private static void Create_TANK_T80U_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    weaponSystemType: WeaponSystemType.Hard,
                    hardAttack: GameData.GEN3_TANK_HARD_ATTACK + MEDIUM_BONUS,
                    hardDefense: GameData.GEN3_TANK_HARD_DEFENSE + LARGE_BONUS,
                    softAttack: GameData.BASE_TANK_SOFT_ATTACK,
                    softDefense: GameData.BASE_TANK_SOFT_DEFENSE,
                    groundAirDefense: GameData.GROUND_DEFENSE_ARMOR,
                    primaryRange:    GameData.PRIMARY_RANGE_DEFAULT,
        ...
        private static void Create_TANK_T80BV_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    weaponSystemType: WeaponSystemType.Hard,
                    hardAttack: GameData.GEN4_TANK_HARD_ATTACK + SMALL_BONUS,
                    hardDefense: GameData.GEN4_TANK_HARD_DEFENSE,
                    softAttack: GameData.BASE_TANK_SOFT_ATTACK + SMALL_BONUS,
                    softDefense: GameData.BASE_TANK_SOFT_DEFENSE + SMALL_BONUS,
                    groundAirDefense: GameData.GROUND_DEFENSE_ARMOR,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
                    indirectRange: GameData.INDIRECT_RANGE_DEFAULT,
        ...
        private static void Create_APC_MTLB_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    hardDefense: GameData.BASE_APC_HARD_DEFENSE,
                    softAttack: GameData.BASE_APC_SOFT_ATTACK,
                    softDefense: GameData.BASE_APC_SOFT_DEFENSE,
        ...
        private static void Create_APC_BTR70_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    hardDefense: GameData.BASE_APC_HARD_DEFENSE,
                    softAttack: GameData.BASE_APC_SOFT_ATTACK,
                    softDefense: GameData.BASE_APC_SOFT_DEFENSE + SMALL_BONUS,
                    groundAirDefense: GameData.GROUND_DEFENSE_LIGHTARMOR,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
                    indirectRange: GameData.INDIRECT_RANGE_DEFAULT,
                    spottingRange: GameData.BASE_UNIT_SPOTTING_RANGE,
        ...
        private static void Create_APC_BTR80_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    hardAttack: GameData.BASE_APC_HARD_ATTACK,
                    hardDefense: GameData.BASE_APC_HARD_DEFENSE,
                    softAttack: GameData.BASE_APC_SOFT_ATTACK + SMALL_BONUS,
                    softDefense: GameData.BASE_APC_SOFT_DEFENSE + SMALL_BONUS,
                    groundAirDefense: GameData.GROUND_DEFENSE_LIGHTARMOR,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
                    indirectRange: GameData.INDIRECT_RANGE_DEFAULT,
        ...
        private static void Create_IFV_BMP1_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    weaponSystemType: WeaponSystemType.Hard,
                    hardAttack: GameData.BASE_IFV_HARD_ATTACK + XXLARGE_BONUS,
                    hardDefense: GameData.BASE_IFV_HARD_DEFENSE,
                    softAttack: GameData.BASE_IFV_SOFT_ATTACK,
                    softDefense: GameData.BASE_IFV_SOFT_DEFENSE,
                    groundAirDefense: GameData.GROUND_DEFENSE_LIGHTARMOR,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
                    indirectRange: GameData.INDIRECT_RANGE_DEFAULT,
                    spottingRange: GameData.BASE_UNIT_SPOTTING_RANGE,
        ...
        private static void Create_IFV_BMP2_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    weaponSystemType: WeaponSystemType.Hard,
                    hardAttack: GameData.BASE_IFV_HARD_ATTACK + XXXLARGE_BONUS,
                    hardDefense: GameData.BASE_IFV_HARD_DEFENSE,
                    softAttack: GameData.BASE_IFV_SOFT_ATTACK,
                    softDefense: GameData.BASE_IFV_SOFT_DEFENSE + SMALL_BONUS,
                    groundAirDefense: GameData.GROUND_DEFENSE_LIGHTARMOR,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
                    indirectRange: GameData.INDIRECT_RANGE_DEFAULT,
                    spottingRange: GameData.BASE_UNIT_SPOTTING_RANGE,
        ...
        private static void Create_IFV_BMP3_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    hardAttack: GameData.BASE_IFV_HARD_ATTACK + XXXLARGE_BONUS,
                    hardDefense: GameData.BASE_IFV_HARD_DEFENSE,
                    softAttack: GameData.BASE_IFV_SOFT_ATTACK + SMALL_BONUS,
                    softDefense: GameData.BASE_IFV_SOFT_DEFENSE + MEDIUM_BONUS,
                    groundAirDefense: GameData.GROUND_DEFENSE_LIGHTARMOR,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
                    indirectRange: GameData.INDIRECT_RANGE_DEFAULT,
                    spottingRange: GameData.BASE_UNIT_SPOTTING_RANGE,
        ...
        private static void Create_IFV_BMD3_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    prestigeCost: GameData.PRESTIGE_TIER_1 + MASSIVE_MALUS,
                    weaponSystemType: WeaponSystemType.Hard,
                    hardAttack: GameData.BASE_IFV_HARD_ATTACK,
                    hardDefense: GameData.BASE_IFV_HARD_DEFENSE,
                    softAttack: GameData.BASE_IFV_SOFT_ATTACK + MEDIUM_BONUS,
                    softDefense: GameData.BASE_IFV_SOFT_DEFENSE,
                    groundAirDefense: GameData.GROUND_DEFENSE_LIGHTARMOR,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
                    indirectRange: GameData.INDIRECT_RANGE_DEFAULT,
        ...
        private static void Create_RCN_BRDM2_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
                    indirectRange: GameData.INDIRECT_RANGE_DEFAULT,
                    spottingRange: GameData.RECON_UNIT_SPOTTING_RANGE,
                    allWeatherCapability: AllWeatherRating.GroundUnit,
                    nvgCapability: NVG_Rating.Gen1,
                    silhouette: UnitSilhouette.Small,
                    sigintRating: SIGINT_Rating.UnitLevel,
        ...
        private static void Create_RCN_BRDM2AT_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    weaponSystemType: WeaponSystemType.Hard,
                    hardAttack: GameData.BASE_APC_HARD_ATTACK + XXLARGE_BONUS,
                    hardDefense: GameData.BASE_APC_HARD_DEFENSE,
                    softAttack: GameData.BASE_APC_SOFT_ATTACK,
                    softDefense: GameData.BASE_APC_SOFT_DEFENSE,
                    groundAirDefense: GameData.GROUND_DEFENSE_LIGHTARMOR,
        ...
        private static void Create_SPA_2S1_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    hardDefense: GameData.BASE_ARTY_HARD_DEFENSE + MEDIUM_BONUS,
                    softAttack: GameData.BASE_ARTY_SOFT_ATTACK,
        ...
        private static void Create_SPA_2S3_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    hardAttack: GameData.BASE_ARTY_HARD_ATTACK,
                    hardDefense: GameData.BASE_ARTY_HARD_DEFENSE + MEDIUM_BONUS,
                    softAttack: GameData.BASE_ARTY_SOFT_ATTACK + MEDIUM_BONUS,
                    softDefense: GameData.BASE_ARTY_SOFT_DEFENSE + MEDIUM_BONUS,
                    groundAirDefense: GameData.GROUND_DEFENSE_LIGHTARMOR,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
        ...
        private static void Create_SPA_2S5_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    prestigeCost: GameData.PRESTIGE_TIER_2,
                    weaponSystemType: WeaponSystemType.Hard,
                    hardAttack: GameData.BASE_ARTY_HARD_ATTACK + MEDIUM_BONUS,
                    hardDefense: GameData.BASE_ARTY_HARD_DEFENSE + MEDIUM_BONUS,
                    softAttack: GameData.BASE_ARTY_SOFT_ATTACK + LARGE_BONUS,
                    softDefense: GameData.BASE_ARTY_SOFT_DEFENSE + MEDIUM_BONUS,
                    groundAirDefense: GameData.GROUND_DEFENSE_LIGHTARMOR,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
        ...
        private static void Create_SPA_2S19_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    prestigeCost: GameData.PRESTIGE_TIER_3,
                    weaponSystemType: WeaponSystemType.Hard,
                    hardAttack: GameData.BASE_ARTY_HARD_ATTACK + LARGE_BONUS,
                    hardDefense: GameData.BASE_ARTY_HARD_DEFENSE + MEDIUM_BONUS,
                    softAttack: GameData.BASE_ARTY_SOFT_ATTACK + XLARGE_BONUS,
                    softDefense: GameData.BASE_ARTY_SOFT_DEFENSE + MEDIUM_BONUS,
                    groundAirDefense: GameData.GROUND_DEFENSE_LIGHTARMOR,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
                    indirectRange: GameData.INDIRECT_RANGE_MEDIUM,
        ...
        private static void Create_ROC_BM21_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    groundAirDefense: GameData.GROUND_DEFENSE_LIGHTARMOR,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
                    indirectRange: GameData.INDIRECT_RANGE_ROC_SR,
                    spottingRange: GameData.BASE_UNIT_SPOTTING_RANGE,
                    allWeatherCapability: AllWeatherRating.GroundUnit,
                    nvgCapability: NVG_Rating.None,
                    silhouette: UnitSilhouette.Medium,
                    ...
                    nbcRating: NBC_Rating.Gen1,
                    strategicMobility: StrategicMobility.Heavy,
                    movementPoints: GameData.MOT_UNIT
                );
        ...
        private static void Create_ROC_BM27_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    groundAirDefense: GameData.GROUND_DEFENSE_LIGHTARMOR,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
                    indirectRange: GameData.INDIRECT_RANGE_ROC_MR,
                    spottingRange: GameData.BASE_UNIT_SPOTTING_RANGE,
                    allWeatherCapability: AllWeatherRating.GroundUnit,
                    nvgCapability: NVG_Rating.None,
                    silhouette: UnitSilhouette.Medium,
        ...
        private static void Create_ROC_BM30_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    groundAirDefense: GameData.GROUND_DEFENSE_LIGHTARMOR,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
                    indirectRange: GameData.INDIRECT_RANGE_ROC_LR,
                    spottingRange: GameData.BASE_UNIT_SPOTTING_RANGE,
                    allWeatherCapability: AllWeatherRating.GroundUnit,
                    nvgCapability: NVG_Rating.None,
                    silhouette: UnitSilhouette.Medium,
        ...
        private static void Create_SSM_SCUD_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    hardAttack: GameData.BASE_ARTY_HARD_ATTACK,
                    hardDefense: GameData.BASE_ARTY_HARD_DEFENSE + MEDIUM_BONUS,
                    softAttack: GameData.BASE_ARTY_SOFT_ATTACK + XXXLARGE_BONUS,
                    softDefense: GameData.BASE_ARTY_SOFT_DEFENSE + MEDIUM_BONUS,
                    groundAirDefense: GameData.GROUND_DEFENSE_LIGHTARMOR,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
                    indirectRange: GameData.INDIRECT_RANGE_ROC_LR,
        ...
        private static void Create_SPAAA_ZSU57_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    hardDefense: GameData.BASE_AAA_HARD_DEFENSE,
                    softAttack: GameData.BASE_AAA_SOFT_ATTACK,
                    softDefense: GameData.BASE_AAA_SOFT_DEFENSE,
                    groundAirAttack: GameData.BASE_AAA_GROUND_AIR_ATTACK,
                    groundAirDefense: GameData.GROUND_DEFENSE_AAA,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
                    indirectRange: GameData.INDIRECT_RANGE_AAA,
                    spottingRange: GameData.BASE_AAA_SPOTTING_RANGE,
                    allWeatherCapability: AllWeatherRating.GroundUnit,
                    sigintRating: SIGINT_Rating.UnitLevel,
                    nbcRating: NBC_Rating.None,
                    strategicMobility: StrategicMobility.AirDrop,
        ...
        private static void Create_SPAAA_ZSU23_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    softAttack: GameData.BASE_AAA_SOFT_ATTACK,
                    softDefense: GameData.BASE_AAA_SOFT_DEFENSE,
                    groundAirAttack: GameData.BASE_AAA_GROUND_AIR_ATTACK + MEDIUM_BONUS,
                    groundAirDefense: GameData.GROUND_DEFENSE_AAA,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
                    indirectRange: GameData.INDIRECT_RANGE_AAA,
                    spottingRange: GameData.BASE_AAA_SPOTTING_RANGE,
        ...
        private static void Create_SPAAA_2K22_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    prestigeCost: GameData.PRESTIGE_TIER_2 + MASSIVE_BONUS,
                    weaponSystemType: WeaponSystemType.Hard,
                    hardAttack: GameData.BASE_AAA_HARD_ATTACK,
                    hardDefense: GameData.BASE_AAA_HARD_DEFENSE,
                    softAttack: GameData.BASE_AAA_SOFT_ATTACK,
                    softDefense: GameData.BASE_AAA_SOFT_DEFENSE,
                    groundAirAttack: GameData.BASE_AAA_GROUND_AIR_ATTACK + LARGE_BONUS,
                    groundAirDefense: GameData.GROUND_DEFENSE_AAA + SMALL_BONUS,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
                    indirectRange: GameData.INDIRECT_RANGE_AAA + SMALL_BONUS,
                    spottingRange: GameData.BASE_AAA_SPOTTING_RANGE + SMALL_BONUS,
                    allWeatherCapability: AllWeatherRating.GroundUnit,
        ...
        private static void Create_SPSAM_9K31_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    hardDefense: GameData.BASE_SAM_HARD_DEFENSE,
                    softAttack: GameData.BASE_SAM_SOFT_ATTACK,
                    softDefense: GameData.BASE_SAM_SOFT_DEFENSE,
                    groundAirAttack: GameData.BASE_SAM_GROUND_AIR_ATTACK,
                    groundAirDefense: GameData.GROUND_DEFENSE_SAM,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
                    indirectRange: GameData.INDIRECT_RANGE_SAM,
                    spottingRange: GameData.BASE_SAM_SPOTTING_RANGE,
                    allWeatherCapability: AllWeatherRating.GroundUnit,
                    sigintRating: SIGINT_Rating.UnitLevel,
                    nbcRating: NBC_Rating.Gen1,
                    strategicMobility: StrategicMobility.AirDrop,
        ...
        private static void Create_SAM_S75_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    nvgCapability: NVG_Rating.None,
                    silhouette: UnitSilhouette.Large,
                    movementPoints: GameData.STATIC_UNIT
                );
        ...
        private static void Create_SAM_S125_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    softAttack: GameData.BASE_SAM_SOFT_ATTACK,
                    softDefense: GameData.BASE_SAM_SOFT_DEFENSE,
                    groundAirAttack: GameData.BASE_SAM_GROUND_AIR_ATTACK + MEDIUM_BONUS,
                    groundAirDefense: GameData.GROUND_DEFENSE_SAM,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
                    indirectRange: GameData.INDIRECT_RANGE_SAM,
                    spottingRange: GameData.BASE_SAM_SPOTTING_RANGE,
        ...
        private static void Create_SAM_S300_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    softAttack: GameData.BASE_SAM_SOFT_ATTACK,
                    softDefense: GameData.BASE_SAM_SOFT_DEFENSE,
                    groundAirAttack: GameData.BASE_SAM_GROUND_AIR_ATTACK + XXLARGE_BONUS,
                    groundAirDefense: GameData.GROUND_DEFENSE_SAM,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
                    indirectRange: GameData.INDIRECT_RANGE_SAM + XLARGE_BONUS,
                    spottingRange: GameData.BASE_SAM_SPOTTING_RANGE + XLARGE_BONUS,
                    allWeatherCapability: AllWeatherRating.GroundUnit,
                    sigintRating: SIGINT_Rating.SpecializedLevel,
                    nbcRating: NBC_Rating.Gen2,
                    strategicMobility: StrategicMobility.Heavy,
        ...
        private static void Create_HEL_MI8T_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    hardDefense: GameData.BASE_HEL_HARD_DEFENSE + MEDIUM_MALUS,
                    softAttack: GameData.BASE_HEL_SOFT_ATTACK + MEDIUM_MALUS,
                    softDefense: GameData.BASE_HEL_SOFT_DEFENSE + MEDIUM_MALUS,
                    groundAirDefense: GameData.GROUND_DEFENSE_HELO,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
                    indirectRange: GameData.INDIRECT_RANGE_DEFAULT,
                    spottingRange: GameData.RECON_UNIT_SPOTTING_RANGE,
                    allWeatherCapability: AllWeatherRating.GroundUnit,
                    ...
                    nvgCapability: NVG_Rating.Gen1,
                    silhouette: UnitSilhouette.Medium,
                    movementPoints: GameData.HELO_UNIT
        ...
        private static void Create_HEL_MI8AT_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    hardDefense: GameData.BASE_HEL_HARD_DEFENSE,
                    softAttack: GameData.BASE_HEL_SOFT_ATTACK,
                    softDefense: GameData.BASE_HEL_SOFT_DEFENSE,
                    groundAirDefense: GameData.GROUND_DEFENSE_HELO,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
                    indirectRange: GameData.INDIRECT_RANGE_DEFAULT,
                    spottingRange: GameData.RECON_UNIT_SPOTTING_RANGE,
        ...
        private static void Create_HEL_MI24D_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    prestigeCost: GameData.PRESTIGE_TIER_2,
                    weaponSystemType: WeaponSystemType.Hard,
                    hardAttack: GameData.BASE_HEL_HARD_ATTACK + SMALL_BONUS,
                    hardDefense: GameData.BASE_HEL_HARD_DEFENSE + MEDIUM_BONUS,
                    softAttack: GameData.BASE_HEL_SOFT_ATTACK + SMALL_BONUS,
                    softDefense: GameData.BASE_HEL_SOFT_DEFENSE + SMALL_BONUS,
                    groundAirDefense: GameData.GROUND_DEFENSE_HELO,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
                    indirectRange: GameData.INDIRECT_RANGE_DEFAULT,
                    spottingRange: GameData.RECON_UNIT_SPOTTING_RANGE,
        ...
        private static void Create_HEL_MI24V_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    prestigeCost: GameData.PRESTIGE_TIER_3,
                    weaponSystemType: WeaponSystemType.Hard,
                    hardAttack: GameData.BASE_HEL_HARD_ATTACK + XLARGE_BONUS,
                    hardDefense: GameData.BASE_HEL_HARD_DEFENSE + MEDIUM_BONUS,
                    softAttack: GameData.BASE_HEL_SOFT_ATTACK + SMALL_BONUS,
                    softDefense: GameData.BASE_HEL_SOFT_DEFENSE + SMALL_BONUS,
                    groundAirDefense: GameData.GROUND_DEFENSE_HELO,
        ...
        private static void Create_HEL_MI28_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    prestigeCost: GameData.PRESTIGE_TIER_4,
                    weaponSystemType: WeaponSystemType.Hard,
                    hardAttack: GameData.BASE_HEL_HARD_ATTACK + XXXLARGE_BONUS,
                    hardDefense: GameData.BASE_HEL_HARD_DEFENSE + SMALL_BONUS,
                    softAttack: GameData.BASE_HEL_SOFT_ATTACK + MEDIUM_BONUS,
                    softDefense: GameData.BASE_HEL_SOFT_DEFENSE + SMALL_BONUS,
                    groundAirDefense: GameData.GROUND_DEFENSE_HELO,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
                    indirectRange: GameData.INDIRECT_RANGE_DEFAULT,
        ...
        private static void Create_TRA_AN12_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    maneuverability: GameData.AC_BOMBER_MANEUVER,
                    topSpeed: GameData.AC_BOMBER_TOPSPEED + LARGE_MALUS,
                    survivability: GameData.AC_BOMBER_SURVIVE,
                    groundAttack: GameData.GROUND_ATTACK_NA,
                    ordinanceLoad: GameData.LARGE_AC_LOAD,
                    stealth: 0,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
                    indirectRange: GameData.INDIRECT_RANGE_DEFAULT,
                    spottingRange: GameData.AC_SPOTTING_BASIC,
                    ...
                    nvgCapability: NVG_Rating.None,
                    silhouette: UnitSilhouette.Large,
                    movementPoints: GameData.FIXEDWING_UNIT
                );
        ...
        private static void Create_AWACS_A50_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    dogfighting: GameData.AC_BOMBER_DOGFIGHT,
                    maneuverability: GameData.AC_BOMBER_MANEUVER,
                    topSpeed: GameData.AC_BOMBER_TOPSPEED,
                    survivability: GameData.AC_BOMBER_SURVIVE,
                    groundAttack: GameData.GROUND_ATTACK_NA,
                    ordinanceLoad: GameData.LARGE_AC_LOAD,
                    stealth: 0,
        ...
        private static void Create_ASF_MIG21_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    prestigeCost: GameData.PRESTIGE_TIER_1,
                    weaponSystemType: WeaponSystemType.Air,
                    dogfighting: GameData.EARLY_FGT_DOGFIGHT,
                    maneuverability: GameData.EARLY_FGT_MANEUVER,
                    topSpeed: GameData.EARLY_FGT_TOPSPEED,
                    survivability: GameData.EARLY_FGT_SURVIVE,
                    groundAttack: GameData.GROUND_ATTACK_NA,
                    ordinanceLoad: GameData.SMALL_AC_LOAD,
                    stealth: 0,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
                    indirectRange: GameData.INDIRECT_RANGE_DEFAULT,
                    spottingRange: GameData.AC_SPOTTING_BASIC,
        ...
        private static void Create_ASF_MIG23_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    prestigeCost: GameData.PRESTIGE_TIER_1 + XXLARGE_BONUS,
                    weaponSystemType: WeaponSystemType.Air,
                    dogfighting: GameData.EARLY_FGT_DOGFIGHT + LARGE_BONUS,
                    maneuverability: GameData.EARLY_FGT_MANEUVER,
                    topSpeed: GameData.EARLY_FGT_TOPSPEED + SMALL_BONUS,
                    survivability: GameData.EARLY_FGT_SURVIVE + MEDIUM_BONUS,
                    groundAttack: GameData.GROUND_ATTACK_TIER_0,
                    ordinanceLoad: GameData.SMALL_AC_LOAD,
                    stealth: 0,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
                    indirectRange: GameData.INDIRECT_RANGE_DEFAULT,
                    spottingRange: GameData.AC_SPOTTING_ENHANCED,
        ...
        private static void Create_ASF_MIG25_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    dogfighting: GameData.EARLY_FGT_DOGFIGHT,
                    maneuverability: GameData.EARLY_FGT_MANEUVER,
                    topSpeed: GameData.AC_HIGHSPEED_RUSSIAN,
                    survivability: GameData.EARLY_FGT_SURVIVE,
                    groundAttack: GameData.GROUND_ATTACK_TIER_0,
                    ordinanceLoad: GameData.SMALL_AC_LOAD,
                    stealth: 0,
        ...
        private static void Create_ASF_MIG29_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    prestigeCost: GameData.PRESTIGE_TIER_2,
                    weaponSystemType: WeaponSystemType.Air,
                    dogfighting: GameData.MID_FGT_DOGFIGHT + LARGE_BONUS,
                    maneuverability: GameData.MID_FGT_MANEUVER + XXLARGE_BONUS,
                    topSpeed: GameData.MID_FGT_TOPSPEED + SMALL_BONUS,
                    survivability: GameData.MID_FGT_SURVIVE,
                    groundAttack: GameData.GROUND_ATTACK_TIER_1,
                    ordinanceLoad: GameData.SMALL_AC_LOAD,
                    stealth: 0,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
                    indirectRange: GameData.INDIRECT_RANGE_DEFAULT,
        ...
        private static void Create_ASF_MIG31_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    weaponSystemType: WeaponSystemType.Air,
                    dogfighting: GameData.MID_FGT_DOGFIGHT + LARGE_BONUS,
                    maneuverability: GameData.MID_FGT_MANEUVER,
                    topSpeed: GameData.AC_HIGHSPEED_RUSSIAN,
                    survivability: GameData.MID_FGT_SURVIVE,
                    groundAttack: GameData.GROUND_ATTACK_TIER_1 + LARGE_MALUS,
                    ordinanceLoad: GameData.SMALL_AC_LOAD,
                    stealth: 0,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
                    indirectRange: GameData.INDIRECT_RANGE_DEFAULT,
                    spottingRange: GameData.AC_SPOTTING_ADVANCED,
                    allWeatherCapability: AllWeatherRating.AllWeather,
                    sigintRating: SIGINT_Rating.SpecializedLevel,
                    nbcRating: NBC_Rating.Gen2,
                    strategicMobility: StrategicMobility.Aircraft,
        ...
        private static void Create_ASF_SU27_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    prestigeCost: GameData.PRESTIGE_TIER_3,
                    weaponSystemType: WeaponSystemType.Air,
                    dogfighting: GameData.MID_FGT_DOGFIGHT + XXLARGE_BONUS,
                    maneuverability: GameData.MID_FGT_MANEUVER + MEDIUM_BONUS,
                    topSpeed: GameData.MID_FGT_TOPSPEED + MEDIUM_BONUS,
                    survivability: GameData.MID_FGT_SURVIVE + MEDIUM_BONUS,
                    groundAttack: GameData.GROUND_ATTACK_TIER_1,
                    ordinanceLoad: GameData.SMALL_AC_LOAD,
                    stealth: 0,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
        ...
        private static void Create_ASF_SU47_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    prestigeCost: GameData.PRESTIGE_TIER_3 + XXXLARGE_BONUS + XXXLARGE_BONUS + XXXLARGE_BONUS,
                    weaponSystemType: WeaponSystemType.Air,
                    dogfighting: GameData.LATE_FGT_DOGFIGHT + XXXLARGE_BONUS,
                    maneuverability: GameData.LATE_FGT_MANEUVER + XXLARGE_BONUS,
                    topSpeed: GameData.LATE_FGT_TOPSPEED,
                    survivability: GameData.LATE_FGT_SURVIVE,
                    groundAttack: GameData.GROUND_ATTACK_TIER_2,
                    ordinanceLoad: GameData.SMALL_AC_LOAD,
                    stealth: 0,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
                    indirectRange: GameData.INDIRECT_RANGE_DEFAULT,
        ...
        private static void Create_MRF_MIG27_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    prestigeCost: GameData.PRESTIGE_TIER_1 + XXLARGE_BONUS,
                    weaponSystemType: WeaponSystemType.Air,
                    dogfighting: GameData.AC_ATTACK_DOGFIGHT + LARGE_BONUS,
                    maneuverability: GameData.AC_ATTACK_MANEUVER + MEDIUM_BONUS,
                    topSpeed: GameData.AC_ATTACK_TOPSPEED + MEDIUM_BONUS,
                    survivability: GameData.AC_ATTACK_SURVIVE + SMALL_BONUS,
                    groundAttack: GameData.GROUND_ATTACK_TIER_0 + XLARGE_BONUS,
                    ordinanceLoad: GameData.MEDIUM_AC_LOAD,
                    stealth: 0,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
                    indirectRange: GameData.INDIRECT_RANGE_DEFAULT,
                    spottingRange: GameData.AC_SPOTTING_BASIC,
        ...
        private static void Create_ATT_SU25_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    prestigeCost: GameData.PRESTIGE_TIER_2 + XXLARGE_MALUS,
                    weaponSystemType: WeaponSystemType.Air,
                    dogfighting: GameData.AC_ATTACK_DOGFIGHT + MEDIUM_MALUS,
                    maneuverability: GameData.AC_ATTACK_MANEUVER,
                    topSpeed: GameData.AC_ATTACK_TOPSPEED,
                    survivability: GameData.AC_ATTACK_SURVIVE + MEDIUM_BONUS,
                    groundAttack: GameData.GROUND_ATTACK_TIER_1 + LARGE_BONUS,
                    ordinanceLoad: GameData.SMALL_AC_LOAD + LARGE_BONUS,
                    stealth: 0,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
                    indirectRange: GameData.INDIRECT_RANGE_DEFAULT,
                    spottingRange: GameData.AC_SPOTTING_BASIC,
        ...
        private static void Create_ATT_SU25B_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    prestigeCost: GameData.PRESTIGE_TIER_2 + XXLARGE_BONUS,
                    weaponSystemType: WeaponSystemType.Air,
                    dogfighting: GameData.AC_ATTACK_DOGFIGHT,
                    maneuverability: GameData.AC_ATTACK_MANEUVER,
                    topSpeed: GameData.AC_ATTACK_TOPSPEED,
                    survivability: GameData.AC_ATTACK_SURVIVE + XXLARGE_BONUS,
                    groundAttack: GameData.GROUND_ATTACK_TIER_2 + LARGE_BONUS,
                    ordinanceLoad: GameData.SMALL_AC_LOAD + XLARGE_BONUS,
                    stealth: 0,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
                    indirectRange: GameData.INDIRECT_RANGE_DEFAULT,
                    spottingRange: GameData.AC_SPOTTING_BASIC,
        ...
        private static void Create_BMB_SU24_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    prestigeCost: GameData.PRESTIGE_TIER_3 + XXLARGE_MALUS,
                    weaponSystemType: WeaponSystemType.Air,
                    dogfighting: GameData.AC_BOMBER_DOGFIGHT + XXLARGE_BONUS,
                    maneuverability: GameData.AC_BOMBER_MANEUVER + LARGE_BONUS,
                    topSpeed: GameData.AC_BOMBER_TOPSPEED + XLARGE_BONUS,
                    survivability: GameData.AC_BOMBER_SURVIVE,
                    groundAttack: GameData.GROUND_ATTACK_TIER_1 + LARGE_BONUS,
                    ordinanceLoad: GameData.LARGE_AC_LOAD,
                    stealth: 0,
        ...
        private static void Create_BMB_TU16_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    maneuverability: GameData.AC_BOMBER_MANEUVER,
                    topSpeed: GameData.AC_BOMBER_TOPSPEED,
                    survivability: GameData.AC_BOMBER_SURVIVE + MEDIUM_BONUS,
                    groundAttack: GameData.GROUND_ATTACK_TIER_1,
                    ordinanceLoad: GameData.XLARGE_AC_LOAD,
                    stealth: 0,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
                    indirectRange: GameData.INDIRECT_RANGE_DEFAULT,
                    spottingRange: GameData.AC_SPOTTING_BASIC,
        ...
        private static void CreateBMB_TU22_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    topSpeed: GameData.AC_BOMBER_TOPSPEED + XLARGE_BONUS,
                    survivability: GameData.AC_BOMBER_SURVIVE,
                    groundAttack: GameData.GROUND_ATTACK_TIER_1 + XLARGE_BONUS,
                    ordinanceLoad: GameData.LARGE_AC_LOAD + SMALL_MALUS,
                    stealth: 0,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
                    indirectRange: GameData.INDIRECT_RANGE_DEFAULT,
                    spottingRange: GameData.AC_SPOTTING_BASIC,
        ...
        private static void Create_BMB_TU22M3_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    dogfighting: GameData.AC_BOMBER_DOGFIGHT,
                    maneuverability: GameData.AC_BOMBER_MANEUVER,
                    topSpeed: GameData.AC_HIGHSPEED_RUSSIAN + SMALL_MALUS,
                    survivability: GameData.AC_BOMBER_SURVIVE,
                    groundAttack: GameData.GROUND_ATTACK_TIER_2 + LARGE_BONUS,
                    ordinanceLoad: GameData.LARGE_AC_LOAD + LARGE_BONUS,
                    stealth: 0,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
                    indirectRange: GameData.INDIRECT_RANGE_DEFAULT,
                    spottingRange: GameData.AC_SPOTTING_BASIC,
        ...
        private static void Create_RCNA_Mig25R_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    dogfighting: GameData.EARLY_FGT_DOGFIGHT,
                    maneuverability: GameData.EARLY_FGT_MANEUVER,
                    topSpeed: GameData.AC_HIGHSPEED_RUSSIAN + MEDIUM_BONUS,
                    survivability: GameData.EARLY_FGT_SURVIVE,
                    groundAttack: GameData.GROUND_ATTACK_TIER_0,
                    ordinanceLoad: GameData.SMALL_AC_LOAD,
                    stealth: 0,
        ...
        private static void Create__TRA_TransportFlotilla_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    nvgCapability: NVG_Rating.None,
                    silhouette: UnitSilhouette.Large,
                    movementPoints: GameData.NAVAL_UNIT
                );
        ...
        private static void Create_TANK_M1_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    weaponSystemType: WeaponSystemType.Hard,
                    hardAttack: GameData.GEN2_TANK_HARD_ATTACK,
                    hardDefense: GameData.GEN2_TANK_HARD_DEFENSE + XXLARGE_BONUS,
                    softAttack: GameData.BASE_TANK_SOFT_ATTACK,
                    softDefense: GameData.BASE_TANK_SOFT_DEFENSE + MEDIUM_BONUS,
                    groundAirDefense: GameData.GROUND_DEFENSE_ARMOR,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
        ...
        private static void Create_TANK_M60A3_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    prestigeCost: GameData.PRESTIGE_TIER_FREE,
                    weaponSystemType: WeaponSystemType.Hard,
                    hardAttack: GameData.GEN1_TANK_HARD_ATTACK + SMALL_BONUS,
                    hardDefense: GameData.GEN1_TANK_HARD_DEFENSE,
                    softAttack: GameData.BASE_TANK_SOFT_ATTACK,
                    softDefense: GameData.BASE_TANK_SOFT_DEFENSE,
                    groundAirDefense: GameData.GROUND_DEFENSE_ARMOR,
        ...
        private static void Create_SPAAA_M163_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    softAttack: GameData.BASE_AAA_SOFT_ATTACK,
                    softDefense: GameData.BASE_AAA_SOFT_DEFENSE,
                    groundAirAttack: GameData.BASE_AAA_GROUND_AIR_ATTACK + SMALL_BONUS,
                    groundAirDefense: GameData.GROUND_DEFENSE_AAA,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
                    indirectRange: GameData.INDIRECT_RANGE_AAA,
                    spottingRange: GameData.BASE_AAA_SPOTTING_RANGE,
        ...
        private static void Create_SAM_Hawk_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    softAttack: GameData.BASE_SAM_SOFT_ATTACK,
                    softDefense: GameData.BASE_SAM_SOFT_DEFENSE,
                    groundAirAttack: GameData.BASE_SAM_GROUND_AIR_ATTACK + LARGE_BONUS,
                    groundAirDefense: GameData.GROUND_DEFENSE_SAM,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
                    indirectRange: GameData.INDIRECT_RANGE_SAM + LARGE_BONUS,
                    spottingRange: GameData.BASE_SAM_SPOTTING_RANGE + LARGE_BONUS,
                    allWeatherCapability: AllWeatherRating.GroundUnit,
                    sigintRating: SIGINT_Rating.SpecializedLevel,
                    nbcRating: NBC_Rating.Gen1,
                    strategicMobility: StrategicMobility.Heavy,
        ...
        private static void Create_ASF_F15_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    prestigeCost: GameData.PRESTIGE_TIER_FREE,
                    weaponSystemType: WeaponSystemType.Air,
                    dogfighting: GameData.MID_FGT_DOGFIGHT + XXXLARGE_BONUS,
                    maneuverability: GameData.MID_FGT_MANEUVER + LARGE_BONUS,
                    topSpeed: GameData.MID_FGT_TOPSPEED + MEDIUM_BONUS,
                    survivability: GameData.MID_FGT_SURVIVE + XLARGE_BONUS,
                    groundAttack: GameData.GROUND_ATTACK_TIER_2,
                    ordinanceLoad: GameData.SMALL_AC_LOAD + LARGE_BONUS,
                    stealth: 0,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
                    indirectRange: GameData.INDIRECT_RANGE_DEFAULT,
                    spottingRange: GameData.AC_SPOTTING_SUPERIOR,
                    allWeatherCapability: AllWeatherRating.AllWeather,
                    sigintRating: SIGINT_Rating.UnitLevel,
                    nbcRating: NBC_Rating.Gen2,
                    strategicMobility: StrategicMobility.Aircraft,
        ...
        private static void Create_ASF_F4_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    prestigeCost: GameData.PRESTIGE_TIER_FREE,
                    weaponSystemType: WeaponSystemType.Air,
                    dogfighting: GameData.EARLY_FGT_DOGFIGHT + MEDIUM_BONUS,
                    maneuverability: GameData.EARLY_FGT_MANEUVER,
                    topSpeed: GameData.EARLY_FGT_TOPSPEED + MEDIUM_BONUS,
                    survivability: GameData.EARLY_FGT_SURVIVE + MEDIUM_BONUS,
                    groundAttack: GameData.GROUND_ATTACK_TIER_0,
                    ordinanceLoad: GameData.SMALL_AC_LOAD,
                    stealth: 0,
        ...
        private static void Create_MRF_F16_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    prestigeCost: GameData.PRESTIGE_TIER_FREE,
                    weaponSystemType: WeaponSystemType.Air,
                    dogfighting: GameData.MID_FGT_DOGFIGHT + XLARGE_BONUS,
                    maneuverability: GameData.MID_FGT_MANEUVER + XLARGE_BONUS,
                    topSpeed: GameData.MID_FGT_TOPSPEED + SMALL_BONUS,
                    survivability: GameData.MID_FGT_SURVIVE + SMALL_BONUS,
                    groundAttack: GameData.GROUND_ATTACK_TIER_2,
                    ordinanceLoad: GameData.SMALL_AC_LOAD + MEDIUM_BONUS,
                    stealth: 0,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
                    indirectRange: GameData.INDIRECT_RANGE_DEFAULT,
                    spottingRange: GameData.AC_SPOTTING_ADVANCED,
        ...
        private static void Create_ATT_A10_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    topSpeed: GameData.AC_ATTACK_TOPSPEED,
                    survivability: GameData.AC_ATTACK_SURVIVE + XXLARGE_BONUS,
                    groundAttack: GameData.GROUND_ATTACK_TIER_2 + XXLARGE_BONUS,
                    ordinanceLoad: GameData.SMALL_AC_LOAD + XXLARGE_BONUS,
                    stealth: 0,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
                    indirectRange: GameData.INDIRECT_RANGE_DEFAULT,
                    spottingRange: GameData.AC_SPOTTING_BASIC,
        ...
        private static void Create_BMB_F111_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    survivability: GameData.AC_BOMBER_SURVIVE,
                    groundAttack: GameData.GROUND_ATTACK_TIER_2 + LARGE_BONUS,
                    ordinanceLoad: GameData.LARGE_AC_LOAD + MEDIUM_BONUS,
                    stealth: 0,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
                    indirectRange: GameData.INDIRECT_RANGE_DEFAULT,
                    spottingRange: GameData.AC_SPOTTING_ENHANCED,
        ...
        private static void Create_BMB_F117_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    topSpeed: GameData.AC_BOMBER_TOPSPEED,
                    survivability: GameData.AC_BOMBER_SURVIVE,
                    groundAttack: GameData.GROUND_ATTACK_TIER_3 + LARGE_BONUS,
                    ordinanceLoad: GameData.SMALL_AC_LOAD,
                    stealth: 15,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
                    indirectRange: GameData.INDIRECT_RANGE_DEFAULT,
        ...
        private static void Create_RCNA_SR71_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    dogfighting: GameData.EARLY_FGT_DOGFIGHT,
                    maneuverability: GameData.EARLY_FGT_MANEUVER,
                    topSpeed: GameData.AC_HIGHSPEED_WESTERN,
                    survivability: GameData.EARLY_FGT_SURVIVE,
                    groundAttack: GameData.GROUND_ATTACK_TIER_0,
                    ordinanceLoad: GameData.SMALL_AC_LOAD,
                    stealth: 0,
        ...
        private static void Create_TANK_LEOPARD1_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    prestigeCost: GameData.PRESTIGE_TIER_FREE,
                    weaponSystemType: WeaponSystemType.Hard,
                    hardAttack: GameData.GEN1_TANK_HARD_ATTACK + MEDIUM_BONUS,
                    hardDefense: GameData.GEN1_TANK_HARD_DEFENSE + MEDIUM_BONUS,
                    softAttack: GameData.BASE_TANK_SOFT_ATTACK,
                    softDefense: GameData.BASE_TANK_SOFT_DEFENSE,
                    groundAirDefense: GameData.GROUND_DEFENSE_ARMOR,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
        ...
        private static void Create_TANK_LEOPARD2_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    prestigeCost: GameData.PRESTIGE_TIER_FREE,
                    weaponSystemType: WeaponSystemType.Hard,
                    hardAttack: GameData.GEN2_TANK_HARD_ATTACK + XLARGE_BONUS,
                    hardDefense: GameData.GEN2_TANK_HARD_DEFENSE + XXLARGE_BONUS,
                    softAttack: GameData.BASE_TANK_SOFT_ATTACK,
                    softDefense: GameData.BASE_TANK_SOFT_DEFENSE + MEDIUM_BONUS,
                    groundAirDefense: GameData.GROUND_DEFENSE_ARMOR,
        ...
        private static void Create_MRF_TORNADO_IDS_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    prestigeCost: GameData.PRESTIGE_TIER_FREE,
                    weaponSystemType: WeaponSystemType.Air,
                    dogfighting: GameData.MID_FGT_DOGFIGHT + MEDIUM_BONUS,
                    maneuverability: GameData.MID_FGT_MANEUVER,
                    topSpeed: GameData.MID_FGT_TOPSPEED,
                    survivability: GameData.MID_FGT_SURVIVE,
                    groundAttack: GameData.GROUND_ATTACK_TIER_2,
                    ordinanceLoad: GameData.SMALL_AC_LOAD + MEDIUM_BONUS,
                    stealth: 0,
        ...
        private static void Create_TANK_CHALLENGER1_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    prestigeCost: GameData.PRESTIGE_TIER_FREE,
                    weaponSystemType: WeaponSystemType.Hard,
                    hardAttack: GameData.GEN2_TANK_HARD_ATTACK + LARGE_BONUS,
                    hardDefense: GameData.GEN2_TANK_HARD_DEFENSE + XXLARGE_BONUS,
                    softAttack: GameData.BASE_TANK_SOFT_ATTACK,
                    softDefense: GameData.BASE_TANK_SOFT_DEFENSE + MEDIUM_BONUS,
                    groundAirDefense: GameData.GROUND_DEFENSE_ARMOR,
        ...
        private static void Create_IFV_WARRIOR_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    prestigeCost: GameData.PRESTIGE_TIER_FREE,
                    weaponSystemType: WeaponSystemType.Hard,
                    hardAttack: GameData.BASE_IFV_HARD_ATTACK + MEDIUM_BONUS,
                    hardDefense: GameData.BASE_IFV_HARD_DEFENSE,
                    softAttack: GameData.BASE_IFV_SOFT_ATTACK,
                    softDefense: GameData.BASE_IFV_SOFT_DEFENSE,
                    groundAirDefense: GameData.GROUND_DEFENSE_LIGHTARMOR,
        ...
        private static void Create_SAM_Rapier_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    softAttack: GameData.BASE_SAM_SOFT_ATTACK,
                    softDefense: GameData.BASE_SAM_SOFT_DEFENSE,
                    groundAirAttack: GameData.BASE_SAM_GROUND_AIR_ATTACK + SMALL_BONUS,
                    groundAirDefense: GameData.GROUND_DEFENSE_SAM,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
                    indirectRange: GameData.INDIRECT_RANGE_SAM,
                    spottingRange: GameData.BASE_SAM_SPOTTING_RANGE,
        ...
        private static void Create_ATT_JAGUAR_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    dogfighting: GameData.EARLY_FGT_DOGFIGHT,
                    maneuverability: GameData.EARLY_FGT_MANEUVER,
                    topSpeed: GameData.EARLY_FGT_TOPSPEED + MEDIUM_MALUS,
                    survivability: GameData.MID_FGT_SURVIVE + MEDIUM_BONUS,
                    groundAttack: GameData.GROUND_ATTACK_TIER_2,
                    ordinanceLoad: GameData.SMALL_AC_LOAD + LARGE_BONUS,
                    stealth: 0,
        ...
        private static void Create_GENERIC_AAA_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    weaponSystemID: WeaponSystems.AAA_GEN,
                    prestigeCost: GameData.PRESTIGE_TIER_0,
                    weaponSystemType: WeaponSystemType.Soft,
                    hardAttack: GameData.BASE_AAA_HARD_ATTACK,
                    hardDefense: GameData.BASE_AAA_HARD_DEFENSE,
                    ...
                    nvgCapability: NVG_Rating.None,
                    silhouette: UnitSilhouette.Medium,
                    movementPoints: GameData.FOOT_UNIT
                );
                ...
                // Store in master dictionary
                _weaponSystemProfiles[WeaponSystems.AAA_GEN] = profile;
            }
            catch (Exception e)
            {
        ...
        private static void Create_GENERIC_MANPAD_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    nationality: Nationality.GENERIC,
                    weaponSystemID: WeaponSystems.MANPAD_GEN,
                    prestigeCost: GameData.PRESTIGE_TIER_0,
                    weaponSystemType: WeaponSystemType.Soft,
                    hardAttack: GameData.BASE_INF_HARD_ATTACK,
                    hardDefense: GameData.BASE_INF_HARD_DEFENSE,
                    softAttack: GameData.BASE_INF_SOFT_ATTACK,
                    softDefense: GameData.BASE_INF_SOFT_DEFENSE,
                ...
                // Store in master dictionary
                _weaponSystemProfiles[WeaponSystems.MANPAD_GEN] = profile;
            }
            catch (Exception e)
            {
        ...
        private static void Create_GENERIC_LightArt_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    nationality: Nationality.GENERIC,
                    weaponSystemID: WeaponSystems.ART_LIGHT_GEN,
                    prestigeCost: GameData.PRESTIGE_TIER_0,
                    weaponSystemType: WeaponSystemType.Soft,
                    hardAttack: GameData.BASE_ARTY_HARD_ATTACK,
                    hardDefense: GameData.BASE_ARTY_HARD_DEFENSE,
                    softAttack: GameData.BASE_ARTY_SOFT_ATTACK,
                ...
                // Store in master dictionary
                _weaponSystemProfiles[WeaponSystems.ART_LIGHT_GEN] = profile;
            }
            catch (Exception e)
            {
        ...
        private static void Create_GENERIC_HeavytArt_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    nationality: Nationality.GENERIC,
                    weaponSystemID: WeaponSystems.ART_HEAVY_GEN,
                    prestigeCost: GameData.PRESTIGE_TIER_0 + MASSIVE_BONUS,
                    weaponSystemType: WeaponSystemType.Soft,
                    hardAttack: GameData.BASE_ARTY_HARD_ATTACK,
                    hardDefense: GameData.BASE_ARTY_HARD_DEFENSE,
                ...
                // Store in master dictionary
                _weaponSystemProfiles[WeaponSystems.ART_HEAVY_GEN] = profile;
            }
            catch (Exception e)
            {
        ...
        /// <summary>
        /// Create a generic light AT profile.
        /// </summary>
        private static void Create_GENERIC_LightAT_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    nationality: Nationality.GENERIC,
                    weaponSystemID: WeaponSystems.AT_LIGHT_GEN,
                    prestigeCost: GameData.PRESTIGE_TIER_0,
                    weaponSystemType: WeaponSystemType.Soft,
                ...
                // Set upgrade paths
                profile.AddUpgradeType(UpgradeType.AT);

                // Set short name for UI display
                profile.SetShortName("AT");

                // Set turn availability in months.
                profile.SetTurnAvailable(432);

                // Store in master dictionary
                _weaponSystemProfiles[WeaponSystems.AT_LIGHT_GEN] = profile;
            }
            catch (Exception e)
            {
                AppService.HandleException(CLASS_NAME, nameof(Create_GENERIC_LightAT_Profile), e);
                throw;
            }
        }
        ...
        private static void Create_GENERIC_LightMortar_Profile()
        {
            try
            {
                ...
                // Store in master dictionary
                _weaponSystemProfiles[WeaponSystems.ART_LIGHT_MORTAR_GEN] = profile;
            }
            catch (Exception e)
            {
        ...
        private static void Create_GENERIC_HeavyMortar_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    nationality: Nationality.GENERIC,
                    weaponSystemID: WeaponSystems.ART_HEAVY_MORTAR_GEN,
                    prestigeCost: GameData.PRESTIGE_TIER_0 + LARGE_MALUS,
                    weaponSystemType: WeaponSystemType.Soft,
                    hardAttack: GameData.BASE_ARTY_HARD_ATTACK + SMALL_MALUS,
                    hardDefense: GameData.BASE_ARTY_HARD_DEFENSE,
                    softAttack: GameData.BASE_ARTY_SOFT_ATTACK + SMALL_MALUS,
                    softDefense: GameData.BASE_ARTY_SOFT_DEFENSE,
                    groundAirDefense: GameData.GROUND_DEFENSE_INFANTRY,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
                ...
                // Store in master dictionary
                _weaponSystemProfiles[WeaponSystems.ART_HEAVY_MORTAR_GEN] = profile;
            }
            catch (Exception e)
            {
        ...
        private static void Create_GENERIC_CAVALRY_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    nationality: Nationality.GENERIC,
                    weaponSystemID: WeaponSystems.INF_CAV_GEN,
                    prestigeCost: GameData.PRESTIGE_TIER_0,
                    weaponSystemType: WeaponSystemType.Soft,
                    hardAttack: GameData.BASE_INF_HARD_ATTACK,
                    hardDefense: GameData.BASE_INF_HARD_DEFENSE,
                    ...
                    nbcRating: NBC_Rating.Gen1,
                    strategicMobility: StrategicMobility.AirLift,
                    movementPoints: GameData.CAVALRY_UNIT
                );
                ...
                // Store in master dictionary
                _weaponSystemProfiles[WeaponSystems.INF_CAV_GEN] = profile;
            }
            catch (Exception e)
            {
        ...
        private static void Create_GENERIC_TRUCK_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    name: "Truck",
                    nationality: Nationality.GENERIC,
                    weaponSystemID: WeaponSystems.TRUCK_GEN,
                    prestigeCost: GameData.PRESTIGE_TIER_0,
                    weaponSystemType: WeaponSystemType.Soft,
                    hardAttack: GameData.TRUCK_HARD_ATTACK,
                    hardDefense: GameData.TRUCK_HARD_DEFENSE,
                    softAttack: GameData.TRUCK_SOFT_ATTACK,
                    softDefense: GameData.TRUCK_SOFT_DEFENSE,
                    groundAirDefense: GameData.GROUND_DEFENSE_INFANTRY,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
                    indirectRange: GameData.INDIRECT_RANGE_DEFAULT,
                    spottingRange: GameData.BASE_UNIT_SPOTTING_RANGE,
                ...
                // Store in master dictionary
                _weaponSystemProfiles[WeaponSystems.TRUCK_GEN] = profile;
            }
            catch (Exception e)
            {
        ...
        private static void Create_BASE_Landbase_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    prestigeCost: GameData.PRESTIGE_TIER_2,
                    weaponSystemType: WeaponSystemType.Hard,
                    hardAttack: GameData.BASE_HARD_ATTACK,
                    hardDefense: GameData.BASE_HARD_DEFENSE,
                    softAttack: GameData.BASE_SOFT_ATTACK,
                    softDefense: GameData.BASE_SOFT_DEFENSE,
                    groundAirDefense: GameData.GROUND_DEFENSE_INFANTRY,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
                    indirectRange: GameData.INDIRECT_RANGE_DEFAULT,
                    spottingRange: GameData.FACILITY_SPOTTING_RANGE,
                    allWeatherCapability: AllWeatherRating.GroundUnit,
                    nvgCapability: NVG_Rating.None,
                    silhouette: UnitSilhouette.Small,
        ...
        private static void Create_BASE_Intel_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
                    indirectRange: GameData.INDIRECT_RANGE_DEFAULT,
                    spottingRange: GameData.INTEL_UNIT_SPOTTING_RANGE,
                    allWeatherCapability: AllWeatherRating.GroundUnit,
                    nvgCapability: NVG_Rating.None,
                    silhouette: UnitSilhouette.Small,
                    sigintRating: SIGINT_Rating.SpecializedLevel,
        ...
        private static void Create_INF_SPEC_Profile()
        {
            try
            {
                var profile = new WeaponSystemProfile(
                    ...
                    prestigeCost: GameData.PRESTIGE_TIER_0,
                    weaponSystemType: WeaponSystemType.Soft,
                    hardAttack: GameData.BASE_INF_HARD_ATTACK + MEDIUM_BONUS,
                    hardDefense: GameData.BASE_INF_HARD_DEFENSE,
                    softAttack: GameData.BASE_INF_SOFT_ATTACK + MEDIUM_BONUS,
                    softDefense: GameData.BASE_INF_SOFT_DEFENSE,
                    groundAirDefense: GameData.GROUND_DEFENSE_INFANTRY,
                    primaryRange: GameData.PRIMARY_RANGE_DEFAULT,
                    indirectRange: GameData.INDIRECT_RANGE_DEFAULT,
