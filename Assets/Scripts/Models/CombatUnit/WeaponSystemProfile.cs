...
namespace HammerAndSickle.Models
{
    ...
    **ID Generation Strategy**
    ...
    public class WeaponSystemProfile : ISerializable, ICloneable
    {
        ...
        /// <summary>
        /// Creates a deep copy of this WeaponSystemProfile with a new name and optionally new WeaponSystemID.
        /// The WeaponSystemID is generated by appending a GUID suffix to ensure uniqueness.
        /// </summary>
        /// <param name="newName">The name for the cloned profile</param>
        /// <returns>A new WeaponSystemProfile with identical values but different name and ID</returns>
        public WeaponSystemProfile Clone(string newName)
        {
            try
            {
                ...
                // Create the clone with all original parameters
                var clone = new WeaponSystemProfile(
                    newName,
                    Nationality,
                    WeaponSystemID, // Keep same WeaponSystemID enum value since it represents the type
                    LandHard.Attack, LandHard.Defense,
                    LandSoft.Attack, LandSoft.Defense,
                    LandAir.Attack, LandAir.Defense,
                    Air.Attack, Air.Defense,
