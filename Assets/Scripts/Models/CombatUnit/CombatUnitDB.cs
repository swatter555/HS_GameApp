    ...
    public static class CombatUnitDB
    {
        ...
        public static void CreateSovietNavalInfantryRegiments()
        {
            ...
            var navalInfantryBtr70Regiment = new CombatUnit(
                ...
                mobileProfile: WeaponType.APC_BTR70_SV,
                /* ⚠ TRN_NAVAL REMOVED from the Embarked bay (P1 2026-08-08, §9.10.6 finally enforced):
                 * naval lift is UNIVERSAL and TRANSIENT — never owned. The ratified doc said so since
                 * §9.10.6 was written; this template contradicted it. Marines keep their one real naval
                 * privilege (beachhead landing) by IDENTITY (MMAR), not by possession. */
                embarkedProfile: WeaponType.NONE,
                category: DepotCategory.Secondary,
                size: DepotSize.Small
            );
            ...
            var navalInfantryBtr80Regiment = new CombatUnit(
                ...
                deployedProfile: WeaponType.INF_MAR_SV,
                mobileProfile: WeaponType.APC_BTR80_SV,
                // ⚠ TRN_NAVAL removed (P1 2026-08-08) — see the BTR-70 sister template above.
                embarkedProfile: WeaponType.NONE,
                category: DepotCategory.Secondary,
                size: DepotSize.Small
            );
        ...
        public static void CreateSovietInfantryForces()
        {
            ...
            var spetsnazRegiment = new CombatUnit(
                 ...
                 * that way because the old declared-shape enum could not express "foot infantry whose
                 * only transport is airborne". (P1 2026-08-08: the enum is deleted outright — the shape
                 * is now just Mobile=NONE + a populated Embarked bay, and nothing declares it.) */
        ...
        public static void CreateSovietSAMRegiments()
        {
            ...
            var samS300Regiment = new CombatUnit(
                ...
                side: Side.Player,
                nationality: Nationality.USSR,
                /* ✅ RULED self-contained (Bob, todo_profiles box 1, 2026-08-08): the S-300 rides its own
                 * TELs — it IS its vehicles, like a tank. Under derived capacity nothing here declares
                 * that: SAM_S300_SV's MovementMedium is Wheeled (WeaponProfileDB), so the Mobile bay
                 * closes by physics. Its sisters S-75/S-125 stay Foot-deployed towed batteries whose
                 * open Mobile bay is the normal un-purchased upgrade target (TRK_GEN_SV when bought). */
        ...
        public static void CreateSovietFacilities()
        {
            ...
            var sovSupplyDepot = new CombatUnit(
                ...
                side: Side.Player,
                nationality: Nationality.USSR,
                deployedProfile: WeaponType.BASE_DEPOT,
                mobileProfile: WeaponType.NONE,
                embarkedProfile: WeaponType.NONE,
            ...
            var sovAirbase = new CombatUnit(
                ...
                side: Side.Player,
                nationality: Nationality.USSR,
                deployedProfile: WeaponType.BASE_AIRBASE,
                mobileProfile: WeaponType.NONE,
                embarkedProfile: WeaponType.NONE,
                category: DepotCategory.Main,
                size: DepotSize.Large
            ...
            var sovHQ = new CombatUnit(
                ...
                side: Side.Player,
                nationality: Nationality.USSR,
                deployedProfile: WeaponType.BASE_HQ,
                mobileProfile: WeaponType.NONE,
                embarkedProfile: WeaponType.NONE,
                category: DepotCategory.Main,
        ...
        public static void CreateMujahideenForces()
        {
            ...
            var mjSAMUnit = new CombatUnit(
                ...
                side: Side.AI,
                nationality: Nationality.MJ,
                /* (2026-08-04 this template carried a declared-shape/flag CONTRADICTION — the exact rot
                 * class that killed the declarations. P1 2026-08-08: both are deleted; the Mobile bay is
                 * open because SAM_GEN_MJ is a Foot-deployed towed battery, and Mujahideen picking up a
        ...
        public static void CreateDanishForces()
        {
            ...
            var dk_mech_infantry_brigade = new CombatUnit(
                ...
                side: Side.AI,
                nationality: Nationality.DE,
                deployedProfile: WeaponType.INF_MECH_DK,
                mobileProfile: WeaponType.APC_M113_NATO,
                embarkedProfile: WeaponType.NONE,
                category: DepotCategory.Secondary,
                size: DepotSize.Small
