...
{
/*──────────────────────────────────────────────────────────────────────────
CampaignDateCalendar — turn-based campaign timeline management (1938-2025)
────────────────────────────────────────────────────────────────────────────
Summary
═══════
- Manages campaign timeline from January 1938 to January 2025 with monthly turns
- Converts between MMYYYY date format and absolute turn numbers (0-based)
- Tracks current campaign turn and validates weapon system availability
- Provides turn increment/decrement operations with bounds checking

Public properties
═════════════════
int CurrentTurn { get; private set; }
int CampaignStartTurn { get; private set; }
int CampaignEndTurn { get; private set; }
bool IsActive { get; }
...
Developer notes
═══════════════
- Turn 0 = January 1938, Turn 1044 = January 2025 (87 years × 12 months)
- MMYYYY format: 011938 = January 1938, 122025 = December 2025
- All turn operations are bounds-checked against campaign start/end
- WeaponSystemProfile.TurnAvailable uses same absolute turn numbering
────────────────────────────────────────────────────────────────────────── */
    using global::HammerAndSickle.Models;
    using global::HammerAndSickle.Services;
    using System;
